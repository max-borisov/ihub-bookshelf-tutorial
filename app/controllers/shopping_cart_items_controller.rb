class ShoppingCartItemsController < ApplicationController
  ...
  def create
    ...
    if shopping_cart_item.save
      ...
      redirect_to book_path(params[:book_id]), flash: { danger: "\"#{book_title}\" could not be added to your shopping cart. Please, try again." }
    end
  end
  ...
  def destroy
    ...
    if shopping_cart_item.user_id == current_user.id
      ...
      redirect_to shopping_cart_items_path, notice: "\"#{shopping_cart_item.book.title}\" has been removed for the shopping cart"
    else
